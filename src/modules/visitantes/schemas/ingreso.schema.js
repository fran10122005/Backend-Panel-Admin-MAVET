...
const registrarIngresoSchema = z.object({
  body: z
    ...
    .refine(
      (data) => {
        // Si se envía fecha de nacimiento, validar que esté entre 3 y 120 años
        ...
        return true; // No forzamos que todos los visitantes tengan edad obligatoria en este esquema si no es necesario por el momento,
        // o si el usuario quiere que TODO formulario pida la edad, deberíamos hacerla obligatoria:
      },
      {
